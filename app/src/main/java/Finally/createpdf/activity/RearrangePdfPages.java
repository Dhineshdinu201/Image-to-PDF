...
import Finally.createpdf.adapter.RearrangePdfAdapter;
import Finally.createpdf.util.Constants;
import Finally.createpdf.util.DialogUtils;
import Finally.createpdf.util.ThemeUtils;

import static Finally.createpdf.util.Constants.CHOICE_REMOVE_IMAGE;
import static Finally.createpdf.util.Constants.RESULT;
import static Finally.createpdf.util.Constants.SAME_FILE;
