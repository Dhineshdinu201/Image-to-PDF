package Finally.createpdf.adapter;
...
import Finally.createpdf.interfaces.DataSetChanged;
import Finally.createpdf.interfaces.EmptyStateChangeListener;
import Finally.createpdf.interfaces.ItemSelectedListener;
import Finally.createpdf.model.PDFFile;
import Finally.createpdf.util.DialogUtils;
import Finally.createpdf.util.DirectoryUtils;
import Finally.createpdf.util.FileSortUtils;
import Finally.createpdf.util.FileUtils;
import Finally.createpdf.util.PDFEncryptionUtility;
import Finally.createpdf.util.PDFRotationUtils;
import Finally.createpdf.util.PDFUtils;
import Finally.createpdf.util.PopulateList;
import Finally.createpdf.util.StringUtils;
import Finally.createpdf.util.WatermarkUtils;

import static Finally.createpdf.util.Constants.SORTING_INDEX;
import static Finally.createpdf.util.FileUtils.getFormattedDate;
