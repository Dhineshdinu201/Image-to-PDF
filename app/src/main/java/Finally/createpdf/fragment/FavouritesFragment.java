...
import Finally.createpdf.activity.FavouritesActivity;
import Finally.createpdf.activity.MainActivity;
import Finally.createpdf.customviews.MyCardView;
import Finally.createpdf.fragment.texttopdf.TextToPdfFragment;
import Finally.createpdf.model.HomePageItem;
import Finally.createpdf.util.CommonCodeUtils;

import static Finally.createpdf.util.Constants.ADD_IMAGES;
import static Finally.createpdf.util.Constants.ADD_IMAGES_KEY;
import static Finally.createpdf.util.Constants.ADD_PASSWORD_KEY;
import static Finally.createpdf.util.Constants.ADD_PWD;
import static Finally.createpdf.util.Constants.ADD_TEXT_KEY;
import static Finally.createpdf.util.Constants.ADD_WATERMARK;
import static Finally.createpdf.util.Constants.ADD_WATERMARK_KEY;
import static Finally.createpdf.util.Constants.BUNDLE_DATA;
import static Finally.createpdf.util.Constants.COMPRESS_PDF;
import static Finally.createpdf.util.Constants.COMPRESS_PDF_KEY;
import static Finally.createpdf.util.Constants.EXCEL_TO_PDF_KEY;
import static Finally.createpdf.util.Constants.EXTRACT_IMAGES;
import static Finally.createpdf.util.Constants.EXTRACT_IMAGES_KEY;
import static Finally.createpdf.util.Constants.EXTRACT_TEXT_KEY;
import static Finally.createpdf.util.Constants.HISTORY_KEY;
import static Finally.createpdf.util.Constants.IMAGE_TO_PDF_KEY;
import static Finally.createpdf.util.Constants.INVERT_PDF_KEY;
import static Finally.createpdf.util.Constants.MERGE_PDF_KEY;
import static Finally.createpdf.util.Constants.PDF_TO_IMAGES;
import static Finally.createpdf.util.Constants.PDF_TO_IMAGES_KEY;
import static Finally.createpdf.util.Constants.QR_BARCODE_KEY;
import static Finally.createpdf.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static Finally.createpdf.util.Constants.REMOVE_PAGES;
import static Finally.createpdf.util.Constants.REMOVE_PAGES_KEY;
import static Finally.createpdf.util.Constants.REMOVE_PASSWORD_KEY;
import static Finally.createpdf.util.Constants.REMOVE_PWd;
import static Finally.createpdf.util.Constants.REORDER_PAGES;
import static Finally.createpdf.util.Constants.REORDER_PAGES_KEY;
import static Finally.createpdf.util.Constants.ROTATE_PAGES;
import static Finally.createpdf.util.Constants.ROTATE_PAGES_KEY;
import static Finally.createpdf.util.Constants.SPLIT_PDF_KEY;
import static Finally.createpdf.util.Constants.TEXT_TO_PDF_KEY;
import static Finally.createpdf.util.Constants.VIEW_FILES_KEY;
import static Finally.createpdf.util.Constants.ZIP_TO_PDF_KEY;
